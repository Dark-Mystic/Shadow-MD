...
const VoiceNoteXeon = JSON.parse(fs.readFileSync('./ShadowMedia/database/xeonvn.json'))
const StickerXeon = JSON.parse(fs.readFileSync('./ShadowMedia/database/xeonsticker.json'))
const ImageXeon = JSON.parse(fs.readFileSync('./ShadowMedia/database/xeonimage.json'))
const VideoXeon = JSON.parse(fs.readFileSync('./ShadowMedia/database/xeonvideo.json'))
...
try {
        ...
        //theme sticker reply
        const XeonStickWait = () => {
        let XeonStikRep = fs.readFileSync('./ShadowMedia/theme/sticker_reply/wait.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickAdmin = () => {
        let XeonStikRep = fs.readFileSync('./ShadowMedia/theme/sticker_reply/admin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickBotAdmin = () => {
        let XeonStikRep = fs.readFileSync('./ShadowMedia/theme/sticker_reply/botadmin.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickOwner = () => {
        let XeonStikRep = fs.readFileSync('./ShadowMedia/theme/sticker_reply/owner.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickGroup = () => {
        let XeonStikRep = fs.readFileSync('./ShadowMedia/theme/sticker_reply/group.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
        const XeonStickPrivate = () => {
        let XeonStikRep = fs.readFileSync('./ShadowMedia/theme/sticker_reply/private.webp')
        XeonBotInc.sendMessage(from, { sticker: XeonStikRep }, { quoted: m })
        }
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./ShadowMedia/theme/shadowpic.jpg`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})
}
...
let audiobuffy = fs.readFileSync(`./ShadowMedia/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./ShadowMedia/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./ShadowMedia/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./ShadowMedia/video/${BhosdikaXeon}.mp4`)
...
//Fake
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./ShadowMedia/theme/shadowpic.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case '?': {
            ...
            xeonezy = `
*𝗦𝗛𝗔𝗗𝗢𝗪-𝗠𝗗 𝗠𝗘𝗡𝗨* 
*Hᴇʏ👋, ${pushname}, ${xeonytimewisher}}️*
...
╚═════════════════❀
𝙱𝚘𝚝 𝙼𝚊𝚍𝚎 𝙱𝚢 𝙰𝚜𝚒𝚏🌹
⏤͟͟͞ ⌱ ˹َٰ𝙎.َ𝙃.َٰ𝘼.َٖ𝘿ِٰ.ُِ𝙊.ٍَ𝙒˼ 🫧🇵🇰⃝ ᐞ`
...
VideoXeon.push(q)
await fsx.copy(delb, `./ShadowMedia/video/${q}.mp4`)
fs.writeFileSync('./ShadowMedia/database/xeonvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./ShadowMedia/database/xeonvideo.json', JSON.stringify(VideoXeon))
fs.unlinkSync(`./ShadowMedia/video/${q}.mp4`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ImageXeon.push(q)
await fsx.copy(delb, `./ShadowMedia/image/${q}.jpg`)
fs.writeFileSync('./ShadowMedia/database/xeonimage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./ShadowMedia/database/xeonimage.json', JSON.stringify(ImageXeon))
fs.unlinkSync(`./ShadowMedia/image/${q}.jpg`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
StickerXeon.push(q)
await fsx.copy(delb, `./ShadowMedia/sticker/${q}.webp`)
fs.writeFileSync('./ShadowMedia/database/xeonsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./ShadowMedia/database/xeonsticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(`./ShadowMedia/sticker/${q}.webp`)
...
await fsx.copy(delb, `./ShadowMedia/audio/${q}.mp3`)
fs.writeFileSync('./ShadowMedia/database/xeonvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./ShadowMedia/database/xeonvn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(`./ShadowMedia/audio/${q}.mp3`)
...
let e = String(err)
XeonBotInc.sendMessage("923474187615@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
